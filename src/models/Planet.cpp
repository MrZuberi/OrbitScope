...
Planet::Planet(const std::string& name, float radius, float distanceFromSun, float orbitalPeriod, const glm::vec3& color, const std::string& texturePath, float rotationPeriodHours)
    : m_Name(name)
    , m_Radius(radius)
